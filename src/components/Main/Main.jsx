...
function Main({ userId, mockedData }) {
  ...
  const [isAverageSessionDataLoading, setIsAverageSessionDataLoading] = useState(false);
  const [isUserPerformanceDataLoading, setIsUserPerformanceDataLoading] = useState(false);
  ...
  useEffect(() => {
    ...
    getUserData(userId, mockedData).then((userData) => setUserData(userData)).then((_userData) => setIsUserDataLoading(false));
  ...
  return isUserDataLoading? (
    ...
    <div className="mainContainer">
      ...
      <main>
        ...
        <MainSection
          userData={userData} isUserDataLoading={isUserDataLoading}
          activityData={activityData} isActivityDataLoading={isActivityDataLoading}
          averageSessionData={averageSessionData} isAverageSessionDataLoading={isAverageSessionDataLoading}
          userPerformanceData={userPerformanceData} isUserPerformanceDataLoading={isUserPerformanceDataLoading}
        />
      </main>
    </div>
  );
